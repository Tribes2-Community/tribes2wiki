...
source:
  ...
  archived: 'https://web.archive.org/web/20090629060542id_/http://www.tribes2wiki.com:80/wiki/Spinfusor'
...
The **spinfusor**, or **disc launcher** as it was called in Tribes 1, is far and away the most popular weapon in the game. In many [mods](/scripting/mod "Mod"), the spinfusor appears among the weapons with which you [spawn](/reference/spawn "Spawn"). The spinfusor fires disc-shaped projectiles in a straight line that explode on impact. In most mods, it has a reload time of about two seconds, and does enough damage to handily kill a [light armor](/armors/light-armor "Light armor") in two shots. Almost every player in the game uses a spinfusor in every one of their [loadouts](/start/loadout "Loadout"), as it is a very effective weapon at taking out enemies and can be used effectively at both close and medium range against targets both on the ground and sometimes in the air.
